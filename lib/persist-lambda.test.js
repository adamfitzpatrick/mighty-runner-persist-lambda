...
describe('persist-lambda', () => {
  ...
  beforeEach(() => {
    ...
    event = {
      Records: [{
        Sns: {
          Message: JSON.stringify({ payload: { key: 'KEY1', sort: 'sort1', data: { thing: 'stuff' } } })
        }
      }, {
        Sns: {
          Message: JSON.stringify({ payload: { key: 'KEY2', sort: 'sort2', data: { thing: 'other stuff' } } })
        }
      }]
    }
  })
    ...
    it('should log the error', () => {
      ...
      const params1 = {
        ...
        Item: {
          key: 'KEY1',
          sort: 'sort1',
          data: JSON.stringify({ key: 'KEY1', sort: 'sort1', data: { thing: 'stuff' } })
        }
      }
      const params2 = {
        TableName: 'table',
        Item: {
          key: 'KEY2',
          sort: 'sort2',
          data: JSON.stringify({ key: 'KEY2', sort: 'sort2', data: { thing: 'other stuff' } })
        }
      }
      docClientMock.expects('put')
